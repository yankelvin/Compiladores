...
public class LabeledExprParser extends Parser {
	...
	public static final int
		MUL=1, DIV=2, ADD=3, SUB=4, EQ=5, APARE=6, FPARE=7, ID=8, INT=9, NEWLINE=10, 
		WS=11;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "MUL", "DIV", "ADD", "SUB", "EQ", "APARE", "FPARE", "ID", "INT", 
			"NEWLINE", "WS"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << APARE) | (1L << ID) | (1L << INT) | (1L << NEWLINE))) != 0) );
			}
		}
